#pragma checksum "E:\PROJETOS\NetCore\AppPrivy\AppPrivy.WebAppSiteBlog\Views\Home\Politica.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "798bd264f6dfd4036d7954a39ab2ea048e31888c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"798bd264f6dfd4036d7954a39ab2ea048e31888c", @"/Views/Home/Politica.cshtml")]
    ...
    public class Views_Home_Politica : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "E:\PROJETOS\NetCore\AppPrivy\AppPrivy.WebAppSiteBlog\Views\Home\Politica.cshtml"
...
<div class=""container-fluid  margin-footer clearfix"">
    ...
    <div class=""container page-header"">
        <h1 class=""text-success"">Política de privacidade<small></small></h1>
    </div>
        ...
        <div class=""row "">
            <div class=""aui-font-header-service"">
                ...
                <div class=""col-md-12"">
                    ...
                    <p>Qualquer uso de cookie");
            WriteLiteral(@"s - ou de outras ferramentas de rastreamento - pelo aplicativo ou pelos proprietários dos serviços terceirizados utilizados por ele, salvo indicação em contrário, servem para identificar os usuários e lembrar as suas preferências, com o único propósito de fornecer os serviços requeridos por eles.</p>
                    ...
                    <p>O controlador de dados processa os dados de usuários de forma adequada e tomará as medidas de segurança adequadas para impedir o acesso não autorizado, di");
            WriteLiteral(@"vulgação, alteração ou destruição não autorizada dos dados.</p>
                    ...
                    <p>Os dados são processados nas sedes de operação do controlador de dados, e em quaisquer outros lugares onde as partes e");
            WriteLiteral(@"nvolvidas com o processamento estejam localizadas. Para mais informações, por favor entre em contato com o controlador de dados.</p>
                    ...
                    <p>Os da");
            WriteLiteral(@"dos pessoais são recolhidos para os seguintes fins e utilizando os seguintes serviços:</p>
            ...
            ");
            WriteLiteral(@"        <p>Este aplicativo tem seu próprio sistema de comentários de conteúdo interno. Dados pessoais coletados: e-mail, nome e sobrenome.</p>
                    ...
                    <p>O botão Curtir do Facebook e widgets sociais são serviços que permitem a interação com a rede social Facebook fornecido pela F");
            WriteLiteral(@"acebook, Inc.</p>
                    ...
                    <p>Ao preencher o formulário de contato com os seus dados, os usuários autorizam este aplicativo a usar esses detalhes para responder ");
            WriteLiteral(@"aos pedidos de informações, cotação ou qualquer outro tipo de pedido como indicado pelo título do formulário.</p>
                    ...
                    <p>Além das informações contidas nesta política de privacidade, este aplicativo poderá fornecer ao usuár");
            WriteLiteral(@"io informações adicionais e contextuais sobre os serviços específicos ou a coleta e processamento de dados pessoais mediante solicitação.</p>
                    ...
                    <p>Os usuários têm o direito de, a qualquer tempo, consultar o controlador de dados para saber se os seus dados pessoais foram armazenados e saber mais sobre o conteúd");
            WriteLiteral(@"o e origem, verificar a sua exatidão ou para pedir que sejam complementados, cancelados, atualizados ou corrigidos, ou que sejam transformados em formato anônimo ou bloquear quaisquer dados mantidos em violação da lei, bem como se opor ao seu tratamento por quaisquer todas as razões legítimas. Os pedidos devem ser enviados para o controlador de dados usando a informação de contato fornecida anteriormente.</p>
                    ...
                    <p>O controlador de dados se reserva o direito de fazer alterações nesta política de privacidade a qualquer momento, mediante comunicação aos seus usuários nesta página. É altamente recomendável que esta página seja consultada várias vezes em r");
            WriteLiteral(@"elação à última modificação descrita na parte inferior. Se o Usuário não concorda com qualquer das alterações da política de privacidade, o usuário deve cessar o uso deste serviço (este aplicativo) e pode solicitar ao controlador de dados que apague os dados pessoais dele. Salvo disposição em contrário, a atual política de privacidade se aplica a todos os dados pessoais dos usuários que o controlador de dados tiver.</p>
                    ...
                    <p>As informações coletadas automaticamente a partir deste serviço (ou serviços de terceiros contratados neste serviç");
            WriteLiteral(@"o (este aplicativo), que podem incluir: os endereços IP ou nomes de domínio dos computadores utilizados pelos usuários que utilizam este aplicativo, os endereços URI (Identificador Uniforme de Recurso), a data e hora do pedido, o método utilizado para submeter o pedido ao servidor, o tamanho do arquivo recebido em resposta, o código numérico que indica o status do servidor de resposta (resultado positivo, erro , etc.), o país de origem, as características do navegador e do sistema operacional utilizado pelo usuário, os vários detalhes de tempo por visita (por exemplo, o tempo gasto em cada página dentro do aplicativo) e os detalhes sobre o caminho seguido dentro da aplicação, com especial referência à sequência de páginas visitadas e outros parâmetros sobre o sistema operacional do dispositivo e/ou ambiente de TI do Usuário.</p>

                    <h3>Usuário</h3>

                    <p>A pessoa que usa este aplicativo que deverá coincidir com ou estar autorizada pelo titular dos dados a quem os dados ");
            WriteLiteral(@"pessoais se referem.</p>
            ...
            WriteLiteral(@"pecificado de outra forma, é o proprietário deste serviço (este aplicativo).</p>
                    ...
                    <p>Esta política de privacidade é apenas sobre este Aplicativo.</p>
